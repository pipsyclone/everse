...
export const Index: React.FC<DashboardProps> = ({ children }) => {
		...
		<div className="relative w-full h-screen flex">
			...
			>
				...
				<div className="flex flex-col gap-3 mt-3">
					<a
						href="/dashboard"
						className="flex border-0 bg-sky-500 text-white rounded-lg p-2 duration-500 ease-in-out"
					>
			...
			>
				<nav className="bg-sky-500 text-white p-3 ps-5 pe-5 flex justify-between items-center">
					<button
						type="button"
						className="text-2xl"
						onClick={() => setSidebar(!sidebar)}
